 ...
 * @stack: ptr to a pointer ptr to top node of the stack.
 * @line_number: Int representing the line number of of the opcode.
 */
 ...
 * @stack: ptr to a potr pointing to top node of the stack.
 * @line_number: Int representing the line number of of the opcode.
 */
 ...
 * @stack: ptr to a ptr pointing to top node of the stack.
 * @line_number: Inte representing the line number of of the opcode.
 */
